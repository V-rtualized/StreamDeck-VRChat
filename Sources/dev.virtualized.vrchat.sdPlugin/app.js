...
function connected(jsn) {
    ...
    $SD.on('dev.virtualized.vrchat.action.willAppear', (jsonObj) => action.onWillAppear(jsonObj));
    $SD.on('dev.virtualized.vrchat.action.keyUp', (jsonObj) => action.onKeyUp(jsonObj));
    $SD.on('dev.virtualized.vrchat.action.sendToPlugin', (jsonObj) => action.onSendToPlugin(jsonObj));
    $SD.on('dev.virtualized.vrchat.action.didReceiveSettings', (jsonObj) => action.onDidReceiveSettings(jsonObj));
    $SD.on('dev.virtualized.vrchat.action.propertyInspectorDidAppear', (jsonObj) => {
